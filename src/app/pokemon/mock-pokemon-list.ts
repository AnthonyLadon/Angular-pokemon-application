// On importe ici la classe pokemon (qui peut etre importé seulemnt si on l'a exporté au préalable)
import { Pokemon } from "./pokemon";

// Ici on informe Typescript que POKEMONS est de type 'tableau de pokemon'
